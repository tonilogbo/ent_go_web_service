...
func ReleaseYear(v int) predicate.Album {
	return predicate.Album(func(s *sql.Selector) {
...
func ReleaseYearEQ(v int) predicate.Album {
	return predicate.Album(func(s *sql.Selector) {
		s.Where(sql.EQ(s.C(FieldReleaseYear), v))
	})
}
...
func ReleaseYearNEQ(v int) predicate.Album {
	return predicate.Album(func(s *sql.Selector) {
...
func ReleaseYearIn(vs ...int) predicate.Album {
	v := make([]interface{}, len(vs))
	for i := range v {
		v[i] = vs[i]
	}
...
func ReleaseYearNotIn(vs ...int) predicate.Album {
	v := make([]interface{}, len(vs))
	for i := range v {
		v[i] = vs[i]
	}
...
func ReleaseYearGT(v int) predicate.Album {
	return predicate.Album(func(s *sql.Selector) {
...
func ReleaseYearGTE(v int) predicate.Album {
	return predicate.Album(func(s *sql.Selector) {
...
func ReleaseYearLT(v int) predicate.Album {
	return predicate.Album(func(s *sql.Selector) {
...
func ReleaseYearLTE(v int) predicate.Album {
	return predicate.Album(func(s *sql.Selector) {
		s.Where(sql.LTE(s.C(FieldReleaseYear), v))
	})
}

// HasBand applies the HasEdge predicate on the "band" edge.
func HasBand() predicate.Album {
	return predicate.Album(func(s *sql.Selector) {
		step := sqlgraph.NewStep(
			sqlgraph.From(Table, FieldID),
			sqlgraph.To(BandTable, FieldID),
			sqlgraph.Edge(sqlgraph.M2M, true, BandTable, BandPrimaryKey...),
		)
		sqlgraph.HasNeighbors(s, step)
	})
}

// HasBandWith applies the HasEdge predicate on the "band" edge with a given conditions (other predicates).
func HasBandWith(preds ...predicate.Band) predicate.Album {
	return predicate.Album(func(s *sql.Selector) {
		step := sqlgraph.NewStep(
			sqlgraph.From(Table, FieldID),
			sqlgraph.To(BandInverseTable, FieldID),
			sqlgraph.Edge(sqlgraph.M2M, true, BandTable, BandPrimaryKey...),
		)
...
func HasArtist() predicate.Album {
	return predicate.Album(func(s *sql.Selector) {
		step := sqlgraph.NewStep(
			...
			sqlgraph.Edge(sqlgraph.M2M, true, ArtistTable, ArtistPrimaryKey...),
		)
		sqlgraph.HasNeighbors(s, step)
	})
}
